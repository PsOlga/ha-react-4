...
function SitySelector ({updateCity}){
   function handleChange(event) {
    updateCity(citiesData[event.target.value]);

   }
  
    return <div className={styles.divSelect}>
      <h1 className={styles.selectCity}>Выберите город:</h1>
<select className={styles.selectCity} onChange={handleChange} name={"Sitys"} id="" >
